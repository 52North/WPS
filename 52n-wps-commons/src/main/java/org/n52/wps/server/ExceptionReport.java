...
/**
 * encapsulates a exception, which occured by service execution and which has to lead to a service Exception
...
public class ExceptionReport extends Exception {
    ...
    /**
     * Operation request does not include a parameter value, and this server did not declare a default value
     * for that parameter
     */
