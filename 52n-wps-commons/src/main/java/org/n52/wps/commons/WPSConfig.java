...
public class WPSConfig implements Serializable {
    ...
    public static WPSConfig getInstance(ServletContext context) {
        LOGGER.debug("Getting WPSConfig instance... with ServletConfig: {}",
    ...
    public Map<String, ConfigurationModule> getRegisteredAlgorithmRepositoryConfigModules() {
        ...
        return configurationManager == null ? new HashMap<String, ConfigurationModule>()
                : configurationManager.getConfigurationServices()
    ...
    public List<? extends ConfigurationEntry<?>> getConfigurationEntriesForGeneratorClass(String name) {
    ...
    public List<? extends ConfigurationEntry<?>> getConfigurationEntriesForParserClass(String name) {
    ...
    public ConfigurationModule getConfigurationModuleForClass(String name,
            ConfigurationCategory moduleCategorie) {
