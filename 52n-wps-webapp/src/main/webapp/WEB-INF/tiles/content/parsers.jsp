		...
		<div class="accordion-group">
			<div class="accordion-heading">
				...
				<div class="accordion-button">
					...
					<a id="moduleStatusButton" class="${statusClass}" href="<c:url value="/parsers/activate/${fullClassName}" />"><c:out
							value="${moduleStatus}" /></a>
				</div>
			</div>
			<div id="${simpleClassName}" class="accordion-body collapse">
				<div class="accordion-inner">
					<form id="module" class="form-horizontal" method="POST" action="<c:url value="/parsers" />">
