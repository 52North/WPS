...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		...
		<AlgorithmDescription>
			...
			<!-- General parameters -->
			<workspaceLocation>./org.n52.wps.ags.merret.modelrouting4</workspaceLocation>
			<algorithmLocation>algorithm://org.n52.wps.ags.merret.modelrouting4/routingtoolbox.tbx?modelrouting4</algorithmLocation>
