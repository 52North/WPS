...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		...
		<AlgorithmDescription>
			...
			<!-- General parameters -->
			<workspaceLocation>./org.n52.wps.ags.custom.buffer</workspaceLocation>
			<algorithmLocation>algorithm://org.n52.wps.ags.merret.buffer/buffernormal.tbx?buffernormal</algorithmLocation>
