...
<div id="footer">
    <div id="f_top">
        <div id="f_navigation">
            ...
            <div class="fn_box">
                ...
                <a href="http://www.opengeospatial.org/" target="_blank" title="OGC Associate Members"><img border="0" alt="" src="<c:url value="/static/images/logos/ogc.gif" />" /></a>
            </div>
            <div class="fn_box">
    ...
    <div id="f_bottom">
        <ul>
            <li class="ja-firstitem"><a href="http://52north.org/communities/geoprocessing/get-involved.html" target="_blank">Get Involved</a></li>
            <li><a href="http://52north.org/communities/geoprocessing/license.html" target="_blank" />License</a></li>
