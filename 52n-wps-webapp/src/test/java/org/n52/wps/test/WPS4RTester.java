...
public class WPS4RTester {
	...
	public static void beforeClass() throws XmlException, IOException {
		...
		try {
			...
			e1.printStackTrace();
			throw new AssertionError("Cannot connect to Rserve. Sip the tests.");
	...
	@AfterClass
	public static void afterClass() throws XmlException, IOException {
	...
	@Test
	public void sessionInfoRetrievedFromWPS() throws MalformedURLException{
	...
	public void resourcesAreLoadedAndRead() throws IOException,
		...
		URL resource = WPS4RTester.class
				.getResource("/R/ExecuteTestResources.xml");
	...
	@Test
	public void decribeProcess() throws IOException,
			ParserConfigurationException, SAXException {
		String identifier = "org.n52.wps.server.r.test_resources";
		String response = GetClient.sendRequest(url,
				"Service=WPS&Request=DescribeProcess&Version=1.0.0&Identifier="
						+ identifier);
	...
	@Test
	public void capabilitiesContainProcess() throws IOException,
			ParserConfigurationException, SAXException {
		String response = GetClient.sendRequest(url,
		...
		assertThat(response, not(containsString("ExceptionReport")));
		assertThat(response,
				containsString("org.n52.wps.server.r.test_resources"));
	}

	@Test
	public void responseTypeIsImage() throws IOException,
			ParserConfigurationException, SAXException, XmlException {

		URL resource = WPS4RTester.class
				.getResource("/R/ExecuteTestImage.xml");
		XmlObject xmlPayload = XmlObject.Factory.parse(resource);
		String payload = xmlPayload.toString();
	...
	@Test
	public void uniformIsExecuted() throws IOException,
			ParserConfigurationException, SAXException, XmlException {

		URL resource = WPS4RTester.class
				.getResource("/R/ExecuteTestUniform.xml");
		XmlObject xmlPayload = XmlObject.Factory.parse(resource);
		String payload = xmlPayload.toString();
