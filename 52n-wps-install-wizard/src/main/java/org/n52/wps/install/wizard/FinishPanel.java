...
public class FinishPanel extends JPanel {
    ...
    public FinishPanel(InstallWizard wizard) {
        ...
        textLabel.setText("Finish WPS Installation");
    ...
    private JPanel getContentPanel() {            
        ...
        jLabel1.setText("The WPS will now be installed to: ");
        
        
        jPanel1.add(yetAnotherBlankSpace1);

        JLabel jLabel2 = new JLabel();
        jLabel2.setText(""+wizard.getProperties().get(InstallLocationPanelDescriptor.TOMCAT_LOCATION));
