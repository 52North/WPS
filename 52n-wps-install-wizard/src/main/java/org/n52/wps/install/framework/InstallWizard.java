...
public class InstallWizard extends WindowAdapter implements PropertyChangeListener {
     ...
     */    
    public InstallWizard(Dialog owner) {
     ...
     */    
    public InstallWizard(Frame owner) {
        wizardModel = new WizardModel();
        wizardDialog = new JDialog(owner);   
        properties = new HashMap<String, Object>();
        initComponents();
   ...
   /**
    ...
    private void initComponents() {
        ...
        nextButton.setSize(new Dimension(200,200));
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName("org.n52.wps.install.wizard.InstallWizard");
   ...
   /**
    ...
    static {
        ...
        try { 
             ...
             ResourceBundle.getBundle("wizard",Locale.getDefault(),InstallWizard.class.getClassLoader());
        	
        	
        
            
            BACK_TEXT = (String)(resources.getString("backButtonText"));
            NEXT_TEXT = (String)(resources.getString("nextButtonText"));
            CANCEL_TEXT = (String)(resources.getString("cancelButtonText"));
            FINISH_TEXT = (String)(resources.getString("finishButtonText"));
            
       
			BACK_ICON = new ImageIcon(resources.getString("backButtonIcon"));
			NEXT_ICON = new ImageIcon(resources.getString("nextButtonIcon"));
	        CANCEL_ICON = new ImageIcon(resources.getString("cancelButtonIcon"));
	        FINISH_ICON = new ImageIcon(resources.getString("finishButtonIcon"));
