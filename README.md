...
If you are interested in alternatives for the WPS, please visit https://github.com/52North/javaps (more recent _WPS_ implementation) or https://github.com/geopython/pygeoapi (_OGC API Processes_ implementation).
