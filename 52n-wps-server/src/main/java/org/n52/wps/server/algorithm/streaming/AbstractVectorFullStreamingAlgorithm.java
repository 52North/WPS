...
public abstract class AbstractVectorFullStreamingAlgorithm extends AbstractSelfDescribingAlgorithm implements Runnable, IObserver {
	...
	public AbstractVectorFullStreamingAlgorithm runnableAlgorithm() {
		return this;
	}
	...
	public Map<String, IData> run(Map<String, List<IData>> inputData) {
		...
		IGenerator chunkGenerator = GeneratorFactory.getInstance().getGenerator(outputFormat.get("schema"), outputFormat.get("mimeType"), outputFormat.get("encoding"), GTVectorDataBinding.class);
		playlistOutputHandler = new PlaylistOutputHandler(new VectorPlaylistGenerator(), chunkGenerator, outputFormat.get("mimeType"), outputFormat.get("schema"), outputFormat.get("encoding"));
