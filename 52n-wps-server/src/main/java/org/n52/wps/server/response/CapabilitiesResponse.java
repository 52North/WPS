...
public class CapabilitiesResponse extends Response {
    ...
    public InputStream getAsStream() throws ExceptionReport {
        try {
            ...
            /*
             * [OGC 06-121r9 OWS Common 2.0]: if acceptVersions parameter was
             * send, the first supported version should be used
             */
            ...
            /*
             * [OGC 06-121r9 OWS Common 2.0]: if no acceptVersions parameter was
             * send, the highest supported version should be used WPS 2.0 in
             * this case
             */
            return CapabilitiesConfigurationV200.getInstance().newInputStream(XMLBeansHelper.getXmlOptions());
        } catch (IOException e) {
            throw new ExceptionReport("Exception occured while generating response", ExceptionReport.NO_APPLICABLE_CODE,
                    e);
