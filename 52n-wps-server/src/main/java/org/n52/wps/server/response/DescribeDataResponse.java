...
public class DescribeDataResponse extends Response{
	...
	public DescribeDataResponse(DescribeDataRequest describeDataRequest){
		super(describeDataRequest);
	}
	...
	public void save(OutputStream os) throws ExceptionReport{
		try {
			...
			((DataDescriptionsDocument)request.getAttachedResult()).save(os,opts);
		}
		catch(IOException e) {
