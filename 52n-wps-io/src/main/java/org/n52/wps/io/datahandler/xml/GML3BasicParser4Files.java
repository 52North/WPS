 ...
 *
 */
public class GML3BasicParser4Files extends AbstractXMLParser implements IStreamableParser {
	...
	public GML3BasicParser4Files(boolean pReadWPSConfig) {
...
//			String filepath =URLDecoder.decode(uri.toASCIIString().replace("file:/", ""));
	...
	public GenericFileDataBinding parseXML(String gml) {
		...
		try{
			...
			fos.close();
			GenericFileDataBinding data = parseXML(f);
