...
public class GTHelper {
    ...
    public static SimpleFeatureType createFeatureType(Collection<Property> attributes,
        ...
        for (Property property : attributes) {
            if (property.getValue() != null) {
                ...
                if ((binding.equals(Geometry.class) || binding.equals(GeometryCollection.class)
                        || binding.equals(MultiCurve.class) || binding.equals(MultiLineString.class)
                        || binding.equals(Curve.class) || binding.equals(MultiPoint.class)
                        || binding.equals(MultiPolygon.class) || binding.equals(MultiSurface.class)
                        || binding.equals(LineString.class) || binding.equals(Point.class)
                        || binding.equals(LineString.class) || binding.equals(Polygon.class))
    ...
    public static SimpleFeatureType createFeatureType(Geometry newGeometry,
            String uuid,
            CoordinateReferenceSystem coordinateReferenceSystem) {
        String namespace = "http://www.52north.org/" + uuid;
    ...
    public static QName createGML3SchemaForFeatureType(SimpleFeatureType featureType) {
        ...
        for (PropertyDescriptor property : attributes) {
            ...
            if (!(property instanceof GeometryDescriptor)) {
                ...
                } else if (property.getType().getBinding().equals(Integer.class)
                        || property.getType().getBinding().equals(BigInteger.class)) {
                    schema = schema + "<xs:element name=\"" + attributeName + "\" minOccurs=\"0\" maxOccurs=\"1\"> "
                            + "<xs:simpleType> ";
    ...
    public static String storeSchema(String schema,
        ...
        if (startIndex < 0) {
            ...
            String baseDir = (baseDirLocation.endsWith("/") ? baseDirLocation : baseDirLocation + File.separator)
                    + "static/schemas" + File.separator;
            ...
            String url = (serviceBaseURL.endsWith("/") ? serviceBaseURL : serviceBaseURL + "/") + "static/schemas/"
                    + uuid + ".xsd";
            return url;
        }
    }
    ...
    public static SimpleFeatureCollection createSimpleFeatureCollectionFromSimpleFeatureList(
