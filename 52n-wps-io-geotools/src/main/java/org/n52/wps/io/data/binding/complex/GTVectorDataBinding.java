...
public class GTVectorDataBinding implements IComplexData {
    ...
    public File getPayloadAsShpFile() {
        try {
            ...
            throw new RuntimeException(
                    "Could not transform Feature Collection into shp file. Reason " + e.getMessage());
        }
    ...
    private synchronized void readObject(java.io.ObjectInputStream oos) throws IOException, ClassNotFoundException {
        ...
        GTVectorDataBinding data =
                parser.parse(stream, parser.getSupportedFormats()[0], parser.getSupportedEncodings()[0]);
