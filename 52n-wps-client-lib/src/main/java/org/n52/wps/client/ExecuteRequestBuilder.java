...
public class ExecuteRequestBuilder {
     ...
     *             if an exception occurred while adding the ComplexData
     */
     ...
     *            mimetype of the data, has to be set
     * @param asReference
     *            true if the data comes from an external source
     * @throws WPSClientException
     *             if an exception occurred while adding the ComplexData
     */
    public void addComplexData(String parameterID,
     ...
     * @param storeSupport
     *            the storeSupported attribute will be set to this boolean value
     * @return always true
     */
    public boolean setStoreSupport(String outputName,
        ...
        // responseDocument.getOutputArray()) {
     ...
     *            the name of the output
     * @param asReference
     *            the asReference attribute will be set to this boolean value
     * @return always true
     */
