...
//                    else if (pname.equalsIgnoreCase(RWPSConfigVariables.R_DATATYPE_CONFIG.toString()) && property.getActive()) {
//                        R_Config.getInstance().setConfigVariable(RWPSConfigVariables.R_DATATYPE_CONFIG, property.getStringValue());
//                    }
//
//                    param.remove(pname);
//                }
