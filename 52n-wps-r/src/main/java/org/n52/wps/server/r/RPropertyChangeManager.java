...
public class RPropertyChangeManager implements PropertyChangeListener {
    ...
    // * Usage: properties were changed -> scripts will be changed scripts were changed (or lack of
    // properties)
    ...
    // }
    // //TODO: register all importand config variables like this so that they are defined only ONCE!!!
    // else if (pname.equalsIgnoreCase(RWPSConfigVariables.R_DATATYPE_CONFIG.toString()) &&
    // property.getActive()) {
    // R_Config.getInstance().setConfigVariable(RWPSConfigVariables.R_DATATYPE_CONFIG,
